...
// Copyright     : (C) 2000 - 2007 Sensoray
///////////////////////////////////////////////////////////////////////////////
...
typedef VOID              (*FPTR_ISR) (DWORD board);	// Pointer to application's interrupt callback function.
typedef VOID              (*FPTR_ERR) (DWORD ErrFlags);	// Pointer to application's error callback function.
